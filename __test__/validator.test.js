...
describe('validator module performs basic validation of', () => {
  ...
  it('objects', () => {
    ...
    let func = () => {};
    let bool = false;
    expect(validator.isObjects(str)).toBeFalsy();
    expect(validator.isObjects(num)).toBeFalsy();
    expect(validator.isObjects(arr)).toBeFalsy();
    expect(validator.isObjects(obj)).toBeTruthy();
    expect(validator.isObjects(func)).toBeFalsy();
    expect(validator.isObjects(bool)).toBeFalsy();
  });
